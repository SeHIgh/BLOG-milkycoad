...
function RenderBlock({ block }: { block: BlockObjectResponse | PartialBlockObjectResponse }) {
  if (!('type' in block)) {
    return null;
  }
  ...
  switch (type) {
    ...
    case 'bookmark':
      return (
        ...
        >
          <div className='font-medium text-blue-600 dark:text-blue-400'>{block.bookmark.url}</div>
